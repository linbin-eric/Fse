...
public class RightTest2
{
    ...
    {
        ByteBuf<?> buf = HeapByteBuf.allocate(256);
        // 创建需要序列化的对象
        ...
        byte[] src = buf.toArray();
        ByteBuffer buffer = ByteBuffer.allocate(src.length);
        buffer.put(src).flip();
        BaseData result = (BaseData) context.deserialize(buffer);
    ...
    public void wrapTest() throws IllegalArgumentException, IllegalAccessException, UnsupportedEncodingException, ClassNotFoundException, InstantiationException
    {
        ...
        ByteBuffer buffer = ByteBuffer.allocate(src.length);
        buffer.put(src).flip();
        WrapData result = (WrapData) context.deserialize(buffer);
    ...
    public void referenceTest() throws IllegalArgumentException, IllegalAccessException, UnsupportedEncodingException, ClassNotFoundException, InstantiationException
    {
        ...
        ByteBuffer buffer = ByteBuffer.allocate(src.length);
        buffer.put(src).flip();
        Person result = context.deserialize(buffer);
    ...
    public void objectTest() throws IllegalArgumentException, IllegalAccessException, ClassNotFoundException, InstantiationException
    {
        ...
        ByteBuffer buffer = ByteBuffer.allocate(src.length);
        buffer.put(src).flip();
        Calendar reCalendar = (Calendar) lbse.deserialize(buffer);
    ...
    public void listTest() throws IllegalArgumentException, IllegalAccessException, ClassNotFoundException, InstantiationException
    {
        ...
        ByteBuffer buffer = ByteBuffer.allocate(src.length);
        buffer.put(src).flip();
        ArrayList<BaseData> result = (ArrayList<BaseData>) lbse.deserialize(buffer);
    ...
    public void objectArrayTest()
    {
        ...
        ByteBuffer buffer = ByteBuffer.allocate(src.length);
        buffer.put(src).flip();
        Object[] result = (Object[]) lbse.deserialize(buffer);
    ...
    public void byteArrayTest()
    {
        ...
        ByteBuffer buffer = ByteBuffer.allocate(src.length);
        buffer.put(src).flip();
        byte[] result = (byte[]) lbse.deserialize(buffer);
    ...
    public void booleanArrayTest()
    {
        ...
        ByteBuffer buffer = ByteBuffer.allocate(src.length);
        buffer.put(src).flip();
        boolean[] result = (boolean[]) lbse.deserialize(buffer);
        for (int i = 0; i < array.length; i++)
        {
            assertEquals(array[i], result[i]);
        }
